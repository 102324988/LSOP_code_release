...
ROOT = "/root/e0lab/e0"
OUT = os.path.join(ROOT, "m1_gen_dg2048")
N_GEN = 10
SEED = 7
N_BINS = 96
...
def main():
    ...
    meta = json.load(open(os.path.join(ROOT, "m1_vae_dg2048_b1e-4", "meta.json")))
    rmaxs = []
    ...
    model.load_state_dict(torch.load(os.path.join(ROOT, "m1_vae_dg2048_b1e-4",
                                                  "model.pt")))
    model.eval()
